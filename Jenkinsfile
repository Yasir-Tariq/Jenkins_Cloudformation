        ...
        stage('Create Cluster Stack') {
          steps {
            ...
            withAWS(region:'us-east-2'){
              output1 = cfnUpdate(stack:'ecs-stack', url:'https://github.com/Yasir-Tariq/Jenkins_Cloudformation/blob/master/ecs.yaml')
              output2 = cfnUpdate(stack:'service-stack', url:'https://github.com/Yasir-Tariq/Jenkins_Cloudformation/blob/master/service.yaml')
            }
          }
        }
    }
