        ...
        stage('Create Cluster Stack') {
          steps {
            ...
            withAWS(region:'us-east-2'){
              def outputs = cfnUpdate(stack:'ecs-stack', url:'https://github.com/Yasir-Tariq/Jenkins_Cloudformation/blob/master/ecs.yaml')
              def outputs = cfnUpdate(stack:'service-stack', url:'https://github.com/Yasir-Tariq/Jenkins_Cloudformation/blob/master/service.yaml')
            }
          }
        }
    }
